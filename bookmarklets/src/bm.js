...
try{
 ...
 const SL={'短距離':[.0132,2.125,2.875,10],'マイル':[.0197,2.267,3.067,15],'中距離':[.03065,2.762,3.737,20],'長距離':[.04109,2.72,3.68,25]}[dist];
 ...
 // 2026/08/23 アプデ: 初期プール金 20万 → 30万（2026/08/25 に 20万 へ戻った）。あわせて「表示オッズが
 ...
 // プールが初期プール金(20万)のまま ＝ 誰も1口も買っていない ＝ **全組が未成立**。
